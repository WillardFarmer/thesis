...
features are required for \gls{pops}? 

%First, let us go over the intended workflow for the tool.
...
\textit{deterministic} aspects of a mission one to two weeks in the future. The reason
