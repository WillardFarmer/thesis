...
\NewDocumentCommand\seh{m}{ \hat{\bm{\mathrm{#1}}} }
...
\NewDocumentCommand\sesv{mm}{ \vec{\bm{\mathrm{#1}}}_{#2} }
...
\NewDocumentCommand\siv{m}{ \sigma_v^2 } \NewDocumentCommand\sio{m}{
\sigma_\omega^2 } \NewDocumentCommand\sir{m}{ \sigma_r^2 }
